...
class SaveAiInsightUseCase @Inject constructor(
    private val repository: AiInsightCacheRepository,
) {
    suspend operator fun invoke(cache: AiInsightCache) = repository.saveInsight(cache)
}
